...
| `optionGrantDate` | `string \| undefined` | Optional | Box 1, Date option granted |
| `optionExerciseDate` | `string \| undefined` | Optional | Box 2, Date option exercised |
| `grantMarketValue` | `number \| undefined` | Optional | Box 3, Fair market value per share on grant date |
| `exerciseMarketValue` | `number \| undefined` | Optional | Box 4, Fair market value per share on exercise date |
| `exercisePrice` | `number \| undefined` | Optional | Box 5, Exercise price paid per share |
| `numberOfShares` | `number \| undefined` | Optional | Box 6, Number of shares transferred |
| `titleTransferDate` | `string \| undefined` | Optional | Box 7, Date legal title transferred |
| `grantDateExercisePrice` | `number \| undefined` | Optional | Box 8, Exercise price per share determined as if the option was exercised on the option granted date |
