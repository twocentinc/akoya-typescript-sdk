...
| `totalMortgagePayments` | `number \| undefined` | Optional | Box 1, Total State HFA (Housing Finance Agency) and homeowner mortgage payments |
| `mortgageAssistancePayments` | `number \| undefined` | Optional | Box 2, State HFA (Housing Finance Agency) mortgage assistance payments |
| `homeownerMortgagePayments` | `number \| undefined` | Optional | Box 3, Homeowner mortgage payments |
