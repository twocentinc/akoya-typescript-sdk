...
| `nonEmployeeCompensation` | `number \| undefined` | Optional | Box 1, Nonemployee compensation |
| `payerDirectSales` | `boolean \| undefined` | Optional | Box 2, Payer made direct sales of $5,000 or more of consumer products to a buyer (recipient) for resale |
| `federalTaxWithheld` | `number \| undefined` | Optional | Box 4, Federal income tax withheld |
| `stateAndLocal` | [`StateAndLocalTaxWithholding[] \| undefined`](../../doc/models/state-and-local-tax-withholding.md) | Optional | Boxes 5-7, State and Local tax withholding |
