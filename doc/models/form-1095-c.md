...
| `selfInsuredCoverage` | `boolean \| undefined` | Optional | Self Insured Coverage |
| `offersOfCoverage` | [`OfferOfHealthInsuranceCoverage[] \| undefined`](../../doc/models/offer-of-health-insurance-coverage.md) | Optional | Boxes 14-16, Employee Offer of Coverage |
| `employeeAge` | `number \| undefined` | Optional | Employee's Age on January 1 |
| `planStartMonth` | `number \| undefined` | Optional | Plan Start Month |
| `coveredIndividuals` | [`HealthInsuranceMarketplaceCoveredIndividual[] \| undefined`](../../doc/models/health-insurance-marketplace-covered-individual.md) | Optional | Boxes 17+, Covered Individuals |
