...
| `dateOfEvent` | `string \| undefined` | Optional | Box 1, Date of identifiable event |
| `amountDischarged` | `number \| undefined` | Optional | Box 2, Amount of debt discharged |
| `interestIncluded` | `number \| undefined` | Optional | Box 3, Interest if included in box 2 |
| `debtDescription` | `string \| undefined` | Optional | Box 4, Debt description |
| `personallyLiable` | `boolean \| undefined` | Optional | Box 5, If checked, the debtor was personally liable for repayment of the debt |
| `debtCode` | `string \| undefined` | Optional | Box 6, Identifiable debt code |
| `fairMarketValue` | `number \| undefined` | Optional | Box 7, Fair market value of property |
