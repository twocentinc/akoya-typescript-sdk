...
| `advancePayments` | `number \| undefined` | Optional | Box 1, Amount of HCTC advance payments |
| `numberOfMonths` | `number \| undefined` | Optional | Box 2, Number of months HCTC advance payments and reimbursement credits paid to you |
| `payments` | [`MonthAndAmount[] \| undefined`](../../doc/models/month-and-amount.md) | Optional | Boxes 3-14, Payments by month |
