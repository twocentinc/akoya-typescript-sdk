...
| `exercisePrice` | `number \| undefined` | Optional | Box 3, Exercise price per share |
| `exerciseMarketValue` | `number \| undefined` | Optional | Box 4, Fair market value per share on exercise date |
| `numberOfShares` | `number \| undefined` | Optional | Box 5, Number of shares transferred |
| `corporation` | [`TaxParty \| undefined`](../../doc/models/tax-party.md) | Optional | Box 6, If other than TRANSFEROR, name, address and tin of corporation whose stock is being transferred |
