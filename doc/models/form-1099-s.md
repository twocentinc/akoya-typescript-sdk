...
| `accountNumber` | `string \| undefined` | Optional | Account or escrow number |
| `dateOfClosing` | `string \| undefined` | Optional | Box 1, Date of closing |
| `grossProceeds` | `number \| undefined` | Optional | Box 2, Gross proceeds |
| `addressOrLegalDescription` | `string \| undefined` | Optional | Box 3, Address or legal description |
| `receivedOtherConsideration` | `boolean \| undefined` | Optional | Box 4, Transferor received or will receive property or services as part of the consideration (if checked) |
| `foreignPerson` | `boolean \| undefined` | Optional | Box 5, If checked, transferor is a foreign person (nonresident alien, foreign partnership, foreign estate, or foreign trust) |
| `realEstateTax` | `number \| undefined` | Optional | Box 6, Buyer's part of real estate tax |
