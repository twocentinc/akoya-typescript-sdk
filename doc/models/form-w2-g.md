...
| `winnings` | `number \| undefined` | Optional | Box 1, Reportable winnings |
| `dateWon` | `string \| undefined` | Optional | Box 2, Date won |
| `typeOfWager` | `string \| undefined` | Optional | Box 3, Type of wager |
| `federalTaxWithheld` | `number \| undefined` | Optional | Box 4, Federal income tax withheld |
| `transaction` | `string \| undefined` | Optional | Box 5, Transaction |
| `race` | `string \| undefined` | Optional | Box 6, Race |
| `identicalWinnings` | `number \| undefined` | Optional | Box 7, Winnings from identical wagers |
| `cashier` | `string \| undefined` | Optional | Box 8, Cashier |
| `window` | `string \| undefined` | Optional | Box 10, Window |
| `firstId` | `string \| undefined` | Optional | Box 11, First I.D. |
| `secondId` | `string \| undefined` | Optional | Box 12, Second I.D. |
| `stateAndLocal` | [`StateAndLocalTaxWithholding[] \| undefined`](../../doc/models/state-and-local-tax-withholding.md) | Optional | Boxes 13-18, State and Local tax withholding, use income fields for state (box 14) and local (box 16) winnings amounts |
