...
| `dateOfSale` | `string \| undefined` | Optional | Box 1, Date of sale or exchange |
| `aggregateAmount` | `number \| undefined` | Optional | Box 2, Aggregate amount received |
| `numberOfShares` | `number \| undefined` | Optional | Box 3, Number of shares exchanged |
| `stockClasses` | `string \| undefined` | Optional | Box 4, Classes of stock exchanged |
