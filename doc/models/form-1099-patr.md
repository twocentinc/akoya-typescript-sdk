...
| `patronageDividends` | `number \| undefined` | Optional | Box 1, Patronage dividends |
| `nonpatronageDistributions` | `number \| undefined` | Optional | Box 2, Nonpatronage distributions |
| `perUnitRetainAllocations` | `number \| undefined` | Optional | Box 3, Per-unit retain allocations |
| `federalTaxWithheld` | `number \| undefined` | Optional | Box 4, Federal income tax withheld |
| `redemption` | `number \| undefined` | Optional | Box 5, Redemption of nonqualified notices and retain allocations |
| `section199Deduction` | `number \| undefined` | Optional | Box 6, Section 199A(g) deduction |
| `qualifiedPayments` | `number \| undefined` | Optional | Box 7, Qualified payments |
| `section199QualifiedItems` | `number \| undefined` | Optional | Box 8, Section 199A(a) qualified items |
| `section199SstbItems` | `number \| undefined` | Optional | Box 9, Section 199A(a) SSTB (Specified Service Trade or Business) items |
| `investmentCredit` | `number \| undefined` | Optional | Box 10, Investment credit |
| `workOpportunityCredit` | `number \| undefined` | Optional | Box 11, Work opportunity credit |
| `otherCreditsAndDeductions` | `number \| undefined` | Optional | Box 12, Other credits and deductions |
| `specifiedCoop` | `boolean \| undefined` | Optional | Box 13, Specified Cooperative |
| `stateAndLocal` | [`StateAndLocalTaxWithholding \| undefined`](../../doc/models/state-and-local-tax-withholding.md) | Optional | State and Local tax withholding, from IRS's IRIS schema |
