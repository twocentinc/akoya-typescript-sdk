...
| `profitOnClosedContracts` | `number \| undefined` | Optional | Box 8, Profit or (loss) realized in current year on closed contracts |
| `unrealizedProfitOpenContractsBegin` | `number \| undefined` | Optional | Box 9, Unrealized profit or loss on open contracts at end of last year |
| `unrealizedProfitOpenContractsEnd` | `number \| undefined` | Optional | Box 10, Unrealized profit or loss on open contracts at end of current year |
| `aggregateProfitOnContracts` | `number \| undefined` | Optional | Box 11, Aggregate profit or (loss) on contracts |
| `bartering` | `number \| undefined` | Optional | Box 13, Bartering |
| `securityDetails` | [`SecurityDetailIrsForm1099B[] \| undefined`](../../doc/models/security-detail-irs-form-1099-b.md) | Optional | Boxes 1-3, 5-7, 12, Security details |
