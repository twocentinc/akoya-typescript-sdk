...
| `dateOfAcquisition` | `string \| undefined` | Optional | Box 1, Date of lender's acquisition or knowledge of abandonment |
| `principalBalance` | `number \| undefined` | Optional | Box 2, Balance of principal outstanding |
| `fairMarketValue` | `number \| undefined` | Optional | Box 4, Fair market value property |
| `personallyLiable` | `boolean \| undefined` | Optional | Box 5, If checked, the borrower was personally liable for repayment of the debt |
| `propertyDescription` | `string \| undefined` | Optional | Box 6, Description of property |
