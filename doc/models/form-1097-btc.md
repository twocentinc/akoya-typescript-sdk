...
| `filingForCredit` | `boolean \| undefined` | Optional | Form 1097-BTC issuer is: Issuer of bond or its agent filing current year Form 1097-BTC for credit being reported |
| `asNominee` | `boolean \| undefined` | Optional | Form 1097-BTC issuer is: An entity or a person that received or should have received a current year Form 1097-BTC and is distributing part or all of that credit to others |
| `total` | `number \| undefined` | Optional | Box 1, Total |
| `bondCode` | `string \| undefined` | Optional | Box 2a, Code |
| `uniqueId` | `string \| undefined` | Optional | Box 2b, Unique Identifier |
| `bondType` | `string \| undefined` | Optional | Box 3, Bond type |
| `amounts` | [`MonthAndAmount[] \| undefined`](../../doc/models/month-and-amount.md) | Optional | Box 5, Amounts by month |
| `comments` | `string \| undefined` | Optional | Box 6, Comments |
