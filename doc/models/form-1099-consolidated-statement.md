...
| `marginInterestPaid` | `number \| undefined` | Optional | Interest paid on margin account |
| `paymentInLieuPaid` | `number \| undefined` | Optional | Payment in lieu of dividends paid |
| `advisorFeesPaid` | `number \| undefined` | Optional | Advisor fees paid |
| `otherFeesPaid` | `number \| undefined` | Optional | Other fees paid |
| `corporateBondInterestPaid` | `number \| undefined` | Optional | Accrued Interest Paid offset to form 1099-INT box 1, Corporate bond interest income |
| `usBondInterestPaid` | `number \| undefined` | Optional | Accrued Interest Paid offset to form 1099-INT box 3, accrued U.S. Treasury Notes and Bonds interest income |
| `taxExemptInterestPaid` | `number \| undefined` | Optional | Accrued Interest Paid offset to form 1099-INT box 8, tax exempt interest income from municipal bonds |
| `specifiedPabInterestPaid` | `number \| undefined` | Optional | Accrued Interest Paid offset to form 1099-INT box 9, tax exempt interest income from Private Activity Bonds |
