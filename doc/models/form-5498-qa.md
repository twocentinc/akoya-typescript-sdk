...
| `ableContributions` | `number \| undefined` | Optional | Box 1, ABLE contributions |
| `rollovers` | `number \| undefined` | Optional | Box 2, ABLE to ABLE Rollovers |
| `cumulativeContributions` | `number \| undefined` | Optional | Box 3, Cumulative contributions |
| `fairMarketValue` | `number \| undefined` | Optional | Box 4, Fair market value |
| `openedInTaxYear` | `boolean \| undefined` | Optional | Box 5, Check if account opened in current tax year |
| `basisOfDisabilityCode` | `string \| undefined` | Optional | Box 6, Basis of eligibility |
| `typeOfDisabilityCode` | `string \| undefined` | Optional | Box 7, Code |
