...
| `earnings` | `number \| undefined` | Optional | Box 2, Earnings |
| `basis` | `number \| undefined` | Optional | Box 3, Basis |
| `trusteeToTrustee` | `boolean \| undefined` | Optional | Box 4, Trustee-to-trustee transfer |
| `tuitionPlanPrivate` | `boolean \| undefined` | Optional | Box 5a, Qualified tuition plan - Private |
| `tuitionPlanPublic` | `boolean \| undefined` | Optional | Box 5b, Qualified tuition plan - Public |
| `coverdellEsa` | `boolean \| undefined` | Optional | Box 5c, Coverdell ESA |
| `recipientIsNotBeneficiary` | `boolean \| undefined` | Optional | Box 6, If this box is checked, the recipient is not the designated beneficiary |
| `fairMarketValue` | `number \| undefined` | Optional | If fair market value (FMV) is included, see Pub. 970, Tax Benefits for Education, for how to figure earnings |
