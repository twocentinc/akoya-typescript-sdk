...
| `earnings` | `number \| undefined` | Optional | Box 2, Earnings on excess contributions |
| `distributionCode` | `string \| undefined` | Optional | Box 3, Distribution code |
| `fairMarketValue` | `number \| undefined` | Optional | Box 4, FMV on date of death |
| `hsa` | `boolean \| undefined` | Optional | Box 5a, HSA |
| `archerAccount` | `boolean \| undefined` | Optional | Box 5b, Archer MSA |
| `medicalSavingsAccount` | `boolean \| undefined` | Optional | Box 5c, Medicare Advantage (MA) MSA |
