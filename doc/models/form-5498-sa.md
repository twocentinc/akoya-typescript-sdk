...
| `msaContributions` | `number \| undefined` | Optional | Box 1, Employee or self-employed person's Archer MSA contributions made in current and following years for current year |
| `totalContributions` | `number \| undefined` | Optional | Box 2, Total contributions made in current year |
| `totalPostYearEnd` | `number \| undefined` | Optional | Box 3, Total HSA or Archer MSA contributions made in following year for current year |
| `rolloverContributions` | `number \| undefined` | Optional | Box 4, Rollover contributions |
| `fairMarketValue` | `number \| undefined` | Optional | Box 5, Fair market value of HSA, Archer MSA, or Medicare Advantage (MA) MSA |
| `hsa` | `boolean \| undefined` | Optional | Box 6a, HSA |
| `archer` | `boolean \| undefined` | Optional | Box 6b, Archer MSA |
| `maMsa` | `boolean \| undefined` | Optional | Box 6c, Medicare Advantage (MA) MSA |
