...
| `policyNumber` | `string \| undefined` | Optional | Policy number |
| `contractInvestment` | `number \| undefined` | Optional | Box 1, Investment in contract |
| `surrenderAmount` | `number \| undefined` | Optional | Box 2, Surrender amount |
| `contactNameAddress` | [`NameAddressAndPhone \| undefined`](../../doc/models/name-address-and-phone.md) | Optional | Issuer's information contact name, street address, city or town, state or province, country, ZIP or foreign postal code, and telephone no. (if different from ISSUER) |
