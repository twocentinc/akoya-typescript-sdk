...
| `programTransfer` | `boolean \| undefined` | Optional | Box 4, Program-to-program transfer |
| `terminated` | `boolean \| undefined` | Optional | Box 5, Check if ABLE account terminated in current year |
| `notBeneficiary` | `boolean \| undefined` | Optional | Box 6, Check if the recipient is not the designated beneficiary |
