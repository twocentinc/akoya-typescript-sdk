...
| `studentLoanInterest` | `number \| undefined` | Optional | Box 1, Student loan interest received by lender |
| `box1ExcludesFees` | `boolean \| undefined` | Optional | Box 2, If checked, box 1 does not include loan origination fee made before September 1, 2004 |
